...
function Register() {
  ...
  const addNewUser = async (e: any) => {
    ...
    var newUser = {
      ...
      category: category,
      organization: e.target[5]?.value.trim(),
    };
          ...
          <div className="flex flex-col  overflow-hidden w-full h-full">
              ...
              >
                      ...
                      <Select onValueChange={(e) => setCategory(e)}>
                          ...
                          <SelectContent>
                              <SelectGroup>
                                  ...
                                  <SelectItem value="Research Scholars">
                                      Research Scholars
                                  </SelectItem>
                                  <SelectItem value="Academicians">
                                      Academicians
                                  </SelectItem>
                                  <SelectItem value="Industry">
                                      Industry Participants
                                  </SelectItem>
                                  <SelectItem value="Foreign Author">
                                      Foreign Authors
                                  </SelectItem>
                              </SelectGroup>
                          </SelectContent>
                  ...
                  <div className="flex flex-col gap-2 my-4">
                      ...
                      <Input
                          id="orgnanization"
                          placeholder="Name of Orgnanization/School/College"
                      />
                  </div>
                  <div className="mt-8 ">
                      <Button
