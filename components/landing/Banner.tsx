...
function Banner() {
    return (
        <>
            ...
            <section className="w-full p-4 md:px-16 lg:max-w-7xl lg:mx-auto">
                <div className="w-full flex flex-col gap-4 bg-purple-100 shadow-md rounded-md p-4 lg:p-12">
                    <div className="text-center lg:text-left lg:w-2/3 flex flex-col gap-2">
                        <h1 className="text-2xl lg:text-4xl font-bold">
                            ICACST-23 Conference
                        </h1>
                        <p className="text-base lg:text-xl font-medium">
                            Join us on 08 December 2023
                        </p>
                    ...
                    <div className="w-full lg:w-1/3 md:flex md:justify-center lg:justify-start">
                        <Button className="w-full md:w-fit font-bold">Register</Button>
                    </div>
                </div>
            </section>
        </>
